                ...
                <div class="playlist-box">
                    ...
                    <div>
                        ...
                        <div v-if="showDetailedCounts">
                            <div class="nodeCount" :key="schema.label" v-for="schema in nodeTypes">
                                {{schema.label}} count: {{selectedNodes.filter((node)=>node.data.label===schema.label).length}}
                            </div>
                        </div>
                        <div class="spacer"></div>
                        <PaginatedList :listData="selectedNodes" 
                            colorPath="selectedNode.color" 
                            columnOnePath="selectedNode.data.name"
                            columnTwoPath="selectedNode.data.label" 
                            :columnTwoStyle="{fontStyle: 'italic', textAlign: 'right', paddingRight: '2rem'}" 
