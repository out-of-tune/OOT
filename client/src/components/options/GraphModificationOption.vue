        ...
        <div class="container" v-for="edgeLabel in getEdges(nodeLabel)" v-bind:key="edgeLabel">
            ...
            <label class="checkbox-container">
                <input type='checkbox'
                    ...
                    @change='updateGraphModificationConfiguration({
                    actionType:"expand", selectedOptions: selectedExpandOptions, nodeType: nodeLabel
                })'/>
                <span class="box">e</span>
            </label>
            <label class="checkbox-container">
                <input type='checkbox' v-model='selectedCollapseOptions' v-bind:value='{"nodeLabel":nodeLabel, "edgeLabel":edgeLabel}' @change='updateGraphModificationConfiguration({actionType:"collapse", selectedOptions: selectedCollapseOptions, nodeType: nodeLabel})' />
