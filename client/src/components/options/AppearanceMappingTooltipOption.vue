<template>
  <div>
    <div class="field">
      ...
      <select id="attributes" v-model="currentTooltip">
        <option
          v-for="attribute in nodeType.attributes"
...
export default {
  props: ["index", "nodeType"],
  computed: {
    ...mapState({
      nodeConfiguration: (state) =>
        state.configurations.appearanceConfiguration.nodeConfiguration,
    }),
    tooltipRules: {
      get() {
