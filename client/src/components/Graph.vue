<template>
  <div>
    ...
    <div class="iconContainer">
      ...
      <v-icon v-if="pendingRequestCount > 0" size="24px" id="loadingIndicator" :color="pendingRequestCount>100? 'red': pendingRequestCount>10?'yellow':'green'">hourglass_empty</v-icon>
...
const QueueDisplay = () => import("@/components/popovers/QueueDisplay.vue")
const NodeLabels = () => import("@/components/helpers/NodeLabels.vue")
