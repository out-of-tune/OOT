        ...
        edgeTypes: [
          {
            ...
            inbound: { from: "genre", to: "genre", connectionName: "subgenres" },
            outbound: { from: "genre", to: "genre", connectionName: "supergenres" }
          },
          {
            label: "Artist_to_Genre",
            inbound: { from: "artist", to: "genre", connectionName: "genres" },
            outbound: { from: "genre", to: "artist", connectionName: "artists" }
          }
        ]
      }
    }
