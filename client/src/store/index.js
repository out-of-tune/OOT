...
const graphIOMutations = [
    'SET_STORED_GRAPH_NAMES'
]
const configurationIOMutations = [
    'SET_STORED_CONFIGURATION_NAMES'
]

const generalSettingsMutations = [
    "SET_SHOW_TOUR"
]
...
export default new Vuex.Store({
    plugins: [
        ...
        createMutationsSharer({ predicate: [...userMutations, ...configurationMutations, ...graphIOMutations, ...configurationIOMutations, ...generalSettingsMutations] })],
    state: {
        mainGraph: {
            graphContainer: {},
            Graph: {},
        ...
        schema: {
            nodeTypes: [
                { label: "artist", attributes: ["name", "id", "popularity", "sid", "mbid", "images"], endpoints:["graphql", "spotify"] },
                { label: "genre", attributes: ["name", "id"], endpoints:["graphql"] },
                { label: "album", attributes: ["name", "id","album_group","album_type","href","release_date","release_date_precision", "sid","total_tracks","type","uri"], endpoints:["spotify"] },
                { label: "song", attributes: ["name", "id","disc_number","duration_ms","explicit","href","is_local","preview_url","sid","track_number","type","uri"], endpoints: ["spotify"] }
            ],
            edgeTypes: [
                {
