...
describe("expandAction", () => {
  ...
  beforeEach(() => {
    ...
    rootState.mainGraph.renderState.layout.isNodePinned.mockReturnValueOnce(true)
    rootState.mainGraph.renderState.layout.isNodePinned.mockReturnValueOnce(false)
