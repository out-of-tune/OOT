...
describe("downloadGraph", () => {
  ...
  it("sets the download URL", () => {
    rootState.mainGraph.renderState.layout.isNodePinned
      ...
      nodesWithPositions: [
        {
          node: {
            id: "Genre/20",
            data: { name: "progressive uplifting trance", label: "genre" },
          },
          position: { x: -1107.951417718828, y: -1420.140698533312 },
          pinned: true,
        },
        {
          node: {
            id: "Genre/137355",
            data: { name: "trance", label: "genre" },
          },
          position: { x: -742.4785465977526, y: -1174.8853946285542 },
          pinned: false,
        },
        {
          node: {
            id: "Genre/184130",
            data: { name: "children's choir", label: "genre" },
          },
          position: { x: -743.4704301191892, y: -1219.5796207330839 },
          pinned: true,
        },
      ],
      links: [
        {
          fromId: "Genre/137355",
          toId: "Genre/20",
          id: "Genre/137355👉 Genre/20",
          linkTypes: ["Genre_to_Genre"],
        },
      ],
    };
  });
