...
describe("INSERT_IN_QUEUE",()=>{
    ...
    beforeEach(()=>{
        state = {
            queue:[{el: "One dummy element ha ha ha"}, {el:"Two dummy element ha ha ha"}]
        }
    })
    it("sets current song", ()=>{
        const song = {el:"A dummy song"}
        ...
        expect(state.queue).toEqual([{el: "One dummy element ha ha ha"}, {el:"A dummy song"},{el:"Two dummy element ha ha ha"}])
    })
})