<template>
  <div class="min-h-full bg-canvas">
    <article class="prose-doc mx-auto max-w-3xl px-6 py-12">
      <h1>Cookie Policy for out-of-tune.org</h1>
      <p>
        This is the Cookie Policy for out-of-tune.org, accessible from
      ...
      <p>Email: office@out-of-tune.org</p>
    </article>
  </div>
</template>
